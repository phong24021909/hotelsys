    ...
    <form action="{{request()->segment(2) == 'product' ? 'shop' :''}}">
        ...
        <div class="filter-widget">
            <h4 class="fw-title">Kind of room (Brand)</h4>
        ...
        <div class="filter-widget">
            ...
            <div class="filter-range-wrap">
                ...
                <div 
                    ...
                    <div class="ui-slider-range ui-corner-all vi-widget-header"></div>
        ...
        <div class="filter-widget">
            ...
            <div class="fw-tags">
                <a href="#">Luxurious amenities</a>
                <a href="#">Close to the beach/entertainment</a>
                <a href="#">Stunning views</a>
                <a href="#">Private and peaceful rooms</a>
