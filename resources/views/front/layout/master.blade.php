...
<head>
    ...
    <title>@yield('title') | E L I S E</title>
            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        <i class="fa fa-envelope"></i> thieuphong0011@gmail.com
                    </div>
                    <div class="phone-service">
                        <i class="fa fa-phone"></i> 0345025547
                    </div>
                </div>
                <div class="ht-right">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <form action="shop">
                            <div class="advanced-search">
                                <button type="button" class="category-btn">All Room</button>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="{{ (request()->segment(1) == 'shop') ? 'active' : '' }}"><a href="./shop">Room</a></li>
            ...
            <div class="row ">
                <div class="col-1g-3 ">
                    <div class="footer-left ">
                        ...
                        <ul>
                            <li>Ha Noi</li>
                            <li>Phone: 0345025547</li>
                            <li>Email: thieuphong0011@gmail.com</li>
                        </ul>
                ...
                <div class="row ">
                    <div class="col-lg-12 ">
                        <div class="copyright-text ">
                            Copyright @ All right reserve | This template made with <a href="https://github.com/phong24021909 ">Nhóm 04</a>
                        </div>
