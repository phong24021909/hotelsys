...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "IQZGVLQW"; //Mã website tại VNPAY
    static $vnp_HashSecret = "KQVCBAGLTZDFWXTVRLNRMBKAQTLMIDFB"; //Chuỗi bí mật
    static $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    static $vnp_Api="https://sandbox.vnpayment.vn/merchant_webapi/api/transaction";
...
//        $vnp_BankCode = 'NCB';
        ...
        // $vnp_TmnCode = "IQZGVLQW";
        // $vnp_HashSecret = "KQVCBAGLTZDFWXTVRLNRMBKAQTLMIDFB";
