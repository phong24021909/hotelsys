...
/**
 * The function adds a product to the cart using AJAX and updates the cart count, total price, and
 * display of the cart items.
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (qty === 0) {
                ...
                cartHover_existItem.find('.total-price').text('$' + (response['cart'].price * response['cart'].qty).toFixed(2));
            }
